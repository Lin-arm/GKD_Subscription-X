...
[![Release](https://img.shields.io/badge/发行版-v90-firebrick)](https://github.com/Lin-arm/gkd-Rules/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-28-brightgreen)](./dist/README.md#应用规则)
...
<!-- - 当前订阅文件已适配 28 个应用，共有 187 应用规则组，0 全局规则组 -->
