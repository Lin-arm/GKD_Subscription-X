...
[![Release](https://img.shields.io/badge/发行版-v65-firebrick)](https://github.com/Lin-arm/gkd-Rules/releases/latest)
...
[![应用规则组](https://img.shields.io/badge/应用规则组-176-orange)](./dist/README.md#应用规则)
...
- 目前主要研究 `ks` , `ks极速版` , `zfb(蚂蚁🌲🐤)` , `7.读📚` 等应用的规则, 如有遇到失效规则, 请到 [Issues](https://github.com/Lin-arm/gkd-Rules/issues)提交快照文件或链接,我将尽力适配。
...
<!-- - 当前订阅文件已适配 22 个应用，共有 176 应用规则组，0 全局规则组 -->
