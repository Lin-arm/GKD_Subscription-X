...
[![Release](https://img.shields.io/badge/发行版-v79-firebrick)](https://github.com/Lin-arm/gkd-Rules/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-23-brightgreen)](./dist/README.md#应用规则)
...
<!-- - 当前订阅文件已适配 23 个应用，共有 176 应用规则组，0 全局规则组 -->
