...
[![Release](https://img.shields.io/badge/发行版-v81-firebrick)](https://github.com/Lin-arm/gkd-Rules/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-25-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-0-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-179-orange)](./dist/README.md#应用规则)
...
<!-- - 当前订阅文件已适配 25 个应用，共有 179 应用规则组，0 全局规则组 -->
